...
def _path(opt, filtered):
  ...
  if dt == 'train':
    path = os.path.join(opt['datapath'], 'KoMultiEmo', 'train.txt')
  elif dt == 'test':
    path = os.path.join(opt['datapath'], 'KoMultiEmo', 'test.txt')
  elif dt == 'valid':
    path = os.path.join(opt['datapath'], 'KoMultiEmo', 'valid.txt')
  else:
